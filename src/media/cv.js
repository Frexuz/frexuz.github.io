export default [
  {
    ...
    texts: [
      'Startup, building SaaS products.',
      'In charge of everything, from hiring people, managing our office, and product development.',
      'Learned a lot about how running a company works, and how to manage employees.',
      'Built a custom live in-app chat.',
    ],
    tags: ['Ruby on Rails', 'React / React Native', 'Websockets', 'AWS'],
  },
  {
    name: 'Casumo',
